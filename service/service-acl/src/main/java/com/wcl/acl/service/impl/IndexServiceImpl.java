...
public class IndexServiceImpl implements IndexService {
    ...
    public Map<String, Object> getUserInfo(String username) {
        ...
        //根据用户id获取角色
        List<RoleEntity> roleList = roleService.selectRoleByUserId(user.getId());
        List<String> roleNameList = roleList.stream().map(RoleEntity::getRoleName).collect(Collectors.toList());
